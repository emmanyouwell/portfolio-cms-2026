                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    >
                        <div className="relative aspect-[4/5] max-w-md mx-auto rounded-3xl overflow-hidden bg-muted/20 border border-white/5">
                            ...
                            {/* Floating Tech Cards */}
                            <motion.div
                                className="absolute top-12 left-8 p-4 bg-background/80 backdrop-blur-md rounded-2xl border border-white/10 shadow-xl"
                                whileHover={{ scale: 1.05 }}
                            >
                                <Code className="w-6 h-6 text-primary" />
                            </motion.div>
                            <motion.div
                                className="absolute bottom-20 right-8 p-4 bg-background/80 backdrop-blur-md rounded-2xl border border-white/10 shadow-xl"
                                whileHover={{ scale: 1.05 }}
                            >
